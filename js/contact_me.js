...
$('#send').click(function(){
    ...
    var phone = $('#phone').val();
    var msg = $('#message').val();
    //window.location = 'mailto:zhangloo333@gmail.com?subject=' + subject + '&body=' + 'LeiRespondTo_email: ' + email + " orPhone: " + phone + ";;;extraMessage: " +msg;
    //window.open('mailto:zhangloo333@gmail.com');
